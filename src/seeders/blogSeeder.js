...
async function seedBlogs() {
  ...
  const blogs = [
    ...
    },
    {
      ...
      date: "2022-09-01",
      description: `
        Gua Jomblang merupakan gua vertikal yang bertipe collapse doline yang juga menjadi objek wisata di Kabupaten Gunungkidul, Daerah Istimewa Yogyakarta. Gua ini terbentuk akibat proses geologi amblasnya tanah beserta vegetasi yang ada di atasnya ke dasar bumi yang terjadi ribuan tahun lalu. Runtuhan ini membentuk sinkhole atau sumuran yang dalam bahasa Jawa dikenal dengan istilah luweng. Itulah yang membuat unik karena di dalam gua terdapat luas mulut gua sekitar 50 meter ini sering disebut dengan nama Luweng Jomblang.
